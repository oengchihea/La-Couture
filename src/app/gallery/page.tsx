            ...
            >
              ...
              >
                ...
                <div className="flex gap-4 mb-6">
                  <button className="flex-1 bg-black text-white px-6 py-2 rounded-full hover:bg-gray-800 transition-colors">
                    Add to Cart
                  </button>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    This premium piece exemplifies our commitment to quality and style. 
